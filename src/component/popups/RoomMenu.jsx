...
const RoomMenu = ({data, showNewMR, setShowNewMR}) => {
   ...
   const {deleteRoom} = useUserContext()
      ...
      <div ref={ref}>
         ...
         <MDBCollapse show={show} className='absolute top-9 left-2 w-max rounded-md shadow-popup z-30'>
            <div className='p-4 bg-subBg rounded-md flex flex-col gap-1'>
               ...
               <button onClick={handleDeleteRoom} className='group flex items-center gap-3 w-full rounded-md p-1 hover:bg-red-700 transition-all duration-200 ease-in-out'>
